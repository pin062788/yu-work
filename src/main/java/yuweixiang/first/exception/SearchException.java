package yuweixiang.first.exception;
...
public class SearchException extends RuntimeException {
     ...
     * @param message 异常信息
     */
    public SearchException(ResultCodeEnum resultCode, String message) {
        super(message);
     ...
     */
    public SearchException(Throwable e, ResultCodeEnum resultCode, String resultDesc) {
        super(resultDesc, e);
        this.resultCode = resultCode;
    }
